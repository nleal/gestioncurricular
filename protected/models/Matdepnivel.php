...
/**
 * This is the model class for table "matdepnivel".
 *
 * The followings are the available columns in table 'matdepnivel':
...
class Matdepnivel extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_materia, id_departamento, nivel, id_mat_dep_nivel', 'required'),
			array('id_materia, id_departamento, nivel, id_mat_dep_nivel', 'numerical', 'integerOnly'=>true),
